...
const AddToLotScreen = ({ route, navigation }: any) => {
    ...
    React.useEffect(() => {
        const loadCompanies = async () => {
            ...
            setCompanies(_companies.filter((x: any) => x.processes.includes(`${+lot.processId + 1}`)));
        };
        loadCompanies();
    }, [isFocused]);
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.formGroupInput}>
                    ...
                    <TextInput style={[styles.formGroupInputText, {backgroundColor: '#bdbdbd', fontSize: 12}]} value={PROCESSES[+lot.processId - 1] + " -> " + PROCESSES[+lot.processId]} editable={false} textAlign='left'/>
                </View>
