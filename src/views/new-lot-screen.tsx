...
const NewLotScreen = ({ navigation }: any) => {
    ...
    const onSave = async () => {
        ...
        const methodToExecute = contractInstance.methods.insertLotProcess(
            ...
            "10753572126", // string memory _companyId,
            ...
            'additional information', // string memory _additionalInformation,
            0 // uint _lotId
        );
        ...
        <ScrollView style={styles.container}>
            <View style={styles.formContainer}>
                ...
                <View style={styles.formGroupInput}>
                    ...
                    <TextInput style={[styles.formGroupInputText, {backgroundColor: '#bdbdbd'}]} placeholder="" value={undefined} editable={false}/>
                </View>
                ...
                <View style={styles.formGroupInput}>
                    ...
                    <View style={[styles.formGroupInputText, {flexDirection: 'row', paddingVertical: 8}]}>
                        <Text style={{flex: 1}}>{operationStartDate.toDateString()}</Text>
                ...
                <View style={styles.formGroupInput}>
                    ...
                    <View style={[styles.formGroupInputText, {flexDirection: 'row', paddingVertical: 8}]}>
                        <Text style={{flex: 1}}>{operationEndDate.toDateString()}</Text>
